...
- Published Agent Skills live in `home/skills/<name>/`. Do not rewrite their contents. Exclusions and the agentskills.io listing notes are in `docs/skills-library.md`. Do not force-add `home/skills/x402/scripts/x402curl`.
